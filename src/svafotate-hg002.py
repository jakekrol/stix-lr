...
parser.add_argument("--timefile", default="../results/2026_08-hg002-svafotate/time.log", help="Optional time log file")
parser.add_argument('--outpattern', default='svafotate-hg002', help='Out file pattern')
