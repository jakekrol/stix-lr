...
### needlr
dir_hg002_needlr=../2026_07-hg002_cmrg-needlr
hg002_needlr_ov05=$dir_hg002_needlr/needLR_ov0.5/needlr_pop_freq.tsv
hg002_needlr_ov07=$dir_hg002_needlr/needLR_ov0.7/needlr_pop_freq.tsv
hg002_needlr_ov09=$dir_hg002_needlr/needLR_ov0.9/needlr_pop_freq.tsv
...
for x in 05 07 09; do
    infile="hg002_needlr_ov${x}"
    outfile="hg002-needlr-ov${x}-popfreqs.txt"
    tail -n +2 ${!infile} | cut -f2 | sort -gr > $outfile
done
...
python $script \
    --figsize 6 5 \
    --inputs "hg002-stix_lr-min_read1-popfreqs.txt,hg002-stix_lr-min_read5-popfreqs.txt,hg002-svafotate-ov05-popfreqs.txt,hg002-svafotate-ov07-popfreqs.txt,hg002-svafotate-ov09-popfreqs.txt,hg002-needlr-ov05-popfreqs.txt,hg002-needlr-ov07-popfreqs.txt,hg002-needlr-ov09-popfreqs.txt" \
